import {
  ...
  type DefaultNodeRenderer = (props: DefaultElementProps) => object;
  type LinkNodeRenderer = (props: LinkRendererProps) => object;
  type ClassNodeRenderer = (props: ClassRendererProps) => string;
  type ImageNodeRenderer = (props: Partial<ImageProps>) => object;
